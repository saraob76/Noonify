...
const StoriesBar = () => {
  ...
  return (
    <div className="w-screen sm:w-[calc(100vw-240px)] no-scrollbar  lg:max-w-2xl overflow-x-auto px-4">
        <div className="flex gap-4 pb-5">

          <div onClick={()=>setShowModal(true)} className="rounded-lg shadow-sm min-w-30 max-w-30
           max-h-40 aspect-[3/4]  cursor-pointer hover:shadow-lg transition-all duration-200 border-2
...

          {
            stories.map((story , index)=>(
                <div onClick={()=> setViewStory(story)}  key={index} className={`relative rounded-lg shadow min-w-30 max-w-30 cursor-pointer
...

                     {
                        story.media_type !== "text" && (
                            ...
                            
                            {
                                ...
                                hover:scale-110 transition duration-200 opacity-70 hover:opacity-80" />
