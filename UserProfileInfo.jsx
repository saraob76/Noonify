...
const UserProfileInfo = ({user , posts , profileId , setShowEdit}) => {
  return (
    <div className="relative py-4 px-6 md:px8 bg-white">
   ...
   <img src={user.profile_picture} alt="" className="absolute rounded-full z-2" />
       ...
       {
        !profileId && <button onClick={()=>setShowEdit(true)} className="flex items-center gap-2 border border-gray-300
        hover:bg-gray-50 py-2 px-4 rounded-lg font-medium transition-colors
