...
}
{
    mode === "media" && previewUrl && (
        media?.type.startsWith("image") ? (
            <img src={previewUrl} alt="" className="obgect-contain max-h-full" />
        ): (
        <video src={previewUrl} className="obgect-contain max-h-full" />
 ...
 {
    bgColors.map((color)=>(
        <button key={color} className="w-6 h-6 rouded-full ring cursor-pointer"
    ...
    <input     /*//////////////////  edit */ onChange={handleMediaUpload}
     ...
     <Upload size={18} /> Photo/Video
           ...
           /*///////////////////  edit */
            ...
            text-white py-3 mt-4 w-full rounded bg-gradient-to-r
